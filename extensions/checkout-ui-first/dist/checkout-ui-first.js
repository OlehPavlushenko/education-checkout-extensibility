...
${errorInfo.componentStack}`);
  ...
  function Extension2() {
    var _a, _b;
    const [variantData, setVariantData] = (0, import_react25.useState)("");
  ...
  function Extension4() {
    ...
    const [yesterday, setYesterday] = (0, import_react27.useState)("");
  ...
  function Extension5() {
    var _a, _b;
    const [products, setVariantsData] = (0, import_react28.useState)([]);
    ...
    if (!metafieldsProduct)
      return null;
    const variantIds = JSON.parse(((_b = (_a = metafieldsProduct[0]) == null ? void 0 : _a.metafield) == null ? void 0 : _b.value) || "[]");
    const { query, i18n } = useApi();
    const applyCartLinesChange = useApplyCartLinesChange();
    const cartLines = useCartLines();
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BlockStack2, { border: "none", padding: ["base", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Heading2, { level: "2", children: "You might also like" }) })
    ] });
  }
