...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-ui-first/src/Banner.jsx
  ...
  function Extension() {
    ...
    const titles = JSON.parse(((_b = (_a = metafieldsTitle[0]) == null ? void 0 : _a.metafield) == null ? void 0 : _b.value) || "[]");
    const texts = JSON.parse(((_d = (_c = metafieldsText[0]) == null ? void 0 : _c.metafield) == null ? void 0 : _d.value) || "[]");
    const images = JSON.parse(((_f = (_e = metafieldsImage[0]) == null ? void 0 : _e.metafield) == null ? void 0 : _f.value) || "[]");
    const itemComponent = titles.map((title, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { border: "base", padding: "base", cornerRadius: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineLayout2, { columns: ["auto", "fill"], spacing: ["none", "base"], blockAlignment: "center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { border: "none", padding: "none", minBlockSize: 64, maxInlineSize: 64, minInlineSize: 64, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Image2, { source: images[index], aspectRatio: 1, alt: title }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { border: "none", padding: "none", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: "2", children: title }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "large", children: texts[index] })
      ] })
    ] }) }, index));
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockLayout2, { rows: ["auto", "auto", "auto"], spacing: ["base", "none"], children: itemComponent });
  }

  // extensions/checkout-ui-first/src/Protect.jsx
  var import_react28 = __toESM(require_react());
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  var Protect_default = reactExtension(
  ...
  function Extension2() {
    ...
    const [variantData, setVariantData] = (0, import_react28.useState)("");
    ...
    const variantId = (_b = (_a = metafieldsProduct[0]) == null ? void 0 : _a.metafield) == null ? void 0 : _b.value;
    ...
    (0, import_react28.useEffect)(() => {
      if (isSelected) {
        ...
        if (foundCartLine) {
          applyCartLinesChange({
            type: "removeCartLine",
            id: foundCartLine == null ? void 0 : foundCartLine.id,
            quantity: 1
          });
        }
      }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockStack2, { border: "none", padding: ["base", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Heading2, { level: "2", children: variantData.product.title }) }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        Pressable2,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(InlineLayout2, { columns: ["auto", 80, "fill"], spacing: ["base", "base"], blockAlignment: "center", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Checkbox2, { checked: isSelected }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              Image2,
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(BlockStack2, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextBlock2, { size: "small", children: variantData.product.description }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "large", children: renderPrice })
            ] })
          ] })
        }
      )
  ...
  // extensions/checkout-ui-first/src/ProductLineItem.jsx
  var import_react29 = __toESM(require_react());
  var import_jsx_runtime6 = __toESM(require_jsx_runtime());
  var ProductLineItem_default = reactExtension(
  ...
  function Extension3() {
    ...
    const [additionalInfo, setAdditionalInfo] = (0, import_react29.useState)("");
    (0, import_react29.useEffect)(() => {
      var _a, _b, _c;
      const productId = (_b = (_a = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _a.product) == null ? void 0 : _b.id;
      if (!productId) {
        return;
      }
      ...
      if (typeof ((_c = metafieldsProduct == null ? void 0 : metafieldsProduct.metafield) == null ? void 0 : _c.value) === "string") {
        setAdditionalInfo(metafieldsProduct.metafield.value);
      }
    }, [cartLineTarget, metafieldsProducts]);
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { size: "small", emphasis: "italic", appearance: "warning", children: additionalInfo });
  }

  // extensions/checkout-ui-first/src/ShippingFields.jsx
  var import_react30 = __toESM(require_react());
  var import_jsx_runtime7 = __toESM(require_jsx_runtime());
  var ShippingFields_default = reactExtension("purchase.checkout.shipping-option-list.render-after", () => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Extension4, {}));
  function Extension4() {
    const [checked, setChecked] = (0, import_react30.useState)(false);
    const [selectedDate, setSelectedDate] = (0, import_react30.useState)(null);
    const [yesterday, setYesterday] = (0, import_react30.useState)("");
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(BlockStack2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Checkbox2, { checked, onChange: handleChange, children: "Provide delivery instructions" }),
      checked && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(BlockStack2, { border: "none", padding: ["base", "none"], children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          DateField2,
          {
            ...
            value: deliveryDate == null ? void 0 : deliveryDate.value,
            disabled: [
              "Sunday",
              "Saturday",
              { end: yesterday }
  ...
  // extensions/checkout-ui-first/src/MightLike.jsx
  var import_react31 = __toESM(require_react());
  var import_jsx_runtime8 = __toESM(require_jsx_runtime());
  var MightLike_default = reactExtension(
    "purchase.checkout.header.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Extension5, {})
  );
  function Extension5() {
    const [products, setVariantsData] = (0, import_react31.useState)([]);
    const [isMetafieldsLoaded, setMetafieldsLoaded] = (0, import_react31.useState)(false);
    const [variantIds, setVariantIds] = (0, import_react31.useState)([]);
    const [adding, setAdding] = (0, import_react31.useState)(false);
    const [showError, setShowError] = (0, import_react31.useState)(false);
    const { query, i18n } = useApi();
    const applyCartLinesChange = useApplyCartLinesChange();
    const cartLines = useCartLines();
    const metafieldsProduct = useAppMetafields({
    ...
    (0, import_react31.useEffect)(() => {
      ...
      if (!isMetafieldsLoaded) {
        if (metafieldsProduct.length > 0) {
          const parsedVariantIds = JSON.parse(((_b = (_a = metafieldsProduct[0]) == null ? void 0 : _a.metafield) == null ? void 0 : _b.value) || "[]");
    ...
    function getVariantsData(variantIds2) {
      return __async(this, null, function* () {
        try {
          const queries = variantIds2.map((variantId, index) => {
            return `
        ...
        ${queries.join("\n")}
          ...
          const products2 = Object.values(queryResult.data);
          if (products2.length > 0) {
            setVariantsData(products2);
          }
        } catch (error) {
          console.error("Error fetching variant data:", error);
        }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Divider2, {}),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BlockStack2, { border: "none", padding: ["base", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Heading2, { level: "1", children: "You might also like" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        Grid2,
        {
          ...
          children: productsOnOffer.slice(0, 2).map((product, index) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            ProductOffer,
            {
              data: product,
              i18n,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BlockSpacer2, { spacing: "loose" }),
      showError && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ErrorBanner, {}),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Divider2, {})
    ] });
  }
  ...
  function ProductOffer({ data, i18n, adding, handleAddToCart }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(View2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BlockStack2, { border: "none", padding: "none", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        Image2,
        {
          border: "base",
          borderWidth: "base",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BlockSpacer2, { spacing: "base" }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(BlockStack2, { border: "none", padding: "none", spacing: "none", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Text2, { size: "medium", emphasis: "strong", children: data.product.title }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Text2, { appearance: "subdued", children: renderPrice })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BlockSpacer2, { spacing: "base" }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BlockStack2, { border: "none", padding: "none", children: data.availableForSale ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        Button2,
        {
          kind: "primary",
          loading: adding,
  ...
  function ErrorBanner() {
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Banner, { status: "critical", children: "There was an issue adding this product. Please try again." });
  }
})();
//# sourceMappingURL=checkout-ui-first.js.map
